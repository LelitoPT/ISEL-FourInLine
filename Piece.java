...
public class Piece {
    ...
    private static Piece last;                       // Refrence to the last piece placed in board
    ...
    public boolean stepFall() {
        ...
        if (line>=Board.DIM_LINES-1)        // Condition to stop fall  [TO CHANGE]
            return false;
    ...
    public void fix() {
        ...
        if (previous!=null) previous.show(); // Show previous as normal piece
